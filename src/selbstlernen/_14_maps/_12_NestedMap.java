...
public class _12_NestedMap {
    /*
    erisim kolayligi acisindan tercih edilebilir
     */
    ...
    public static void main(String[] args) {
        ...
        System.out.println("okulMap = " + okulMap);
        //okulMap = {101={Bolum=MF, Soyisim=Cem, Sube=H, Sinif=10, Isim=Ali},
        // 102={Bolum=TM, Soyisim=Can, Sube=M, Sinif=10, Isim=Ali},
        // 103={Bolum=Soz, Soyisim=Can, Sube=M, Sinif=11, Isim=Ali}}


        // 101 numarali ogrencinin sinifini yazdiralim
